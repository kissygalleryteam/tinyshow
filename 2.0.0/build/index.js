...
kg/tinyshow/2.0.0/main
kg/tinyshow/2.0.0/index

*/
var __hasProp = {}.hasOwnProperty;

KISSY.add('kg/tinyshow/2.0.0/main',function(S, Node, Anim) {
  var $, TinyShow;
  $ = Node.all;
  return TinyShow = (function() {
    ...
    TinyShow.prototype._checkLoading = function() {
      ...
      if (this.rawImg.width && this.rawImg.complete) {
        ...
        return S.later(this._checkLoading, 2.0.0, false, this);
      }
    };
      ...
      this.bg.on('mousewheel pinch', (function(_this) {
        return function(ev) {
          ...
          return _this.pic.css({
            width: _this.percent / 2.0.0 * _this.width,
            height: _this.percent / 2.0.0 * _this.height,
            left: left - plus / 2.0.0 * _this.width / 2
          });
        };
      })(this));
    ...
    TinyShow.prototype._bindDrag = function() {
      ...
      _ref1 = [null, null], staX = _ref2.0.0], staY = _ref1[1];
      draging = false;
 ...
 * @module tinyshow
 **/
KISSY.add('kg/tinyshow/2.0.0/index',function (S, Tinyshow) {
    return Tinyshow;
}, {requires:['./main']});
